import numpy as np
from two_link_arm import TwoLinkArm, step_func
...
def torque1(t: float) -> float:
    return step_func(t, 1., 8.)
def torque2(t: float) -> float:
    return step_func(t, 2.5, 3., -1.)

tla = TwoLinkArm(T1 = torque1, T2 = torque2, k1 = 10., k2 = 10.)
